...
// //           Alchemist’s Grimoire is a smart wellness platform offering medicine reminders, interactive dashboards, 
...
// //         scene="https://prod.spline.design/DWE1dhVVyuzr5zw7/scene.splinecode" 
// //       />
...
const Hero = () => {
  ...
  const handleDocumentationClick = () => {
    if (!user) {
      ...
      navigate("/documentation"); // Example: replace with your documentation route
    }
  };

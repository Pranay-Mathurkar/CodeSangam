    ...
    >
      ...
      >
        <Grid item xs={12} md={6} sx={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
          ...
          >
            <Typography variant="h4" fontWeight={900} mb={3} textAlign="center" color="gold" sx={{ fontSize: { xs: 24, md: 32 } }}>
              Create Your Account
            </Typography>
            ...
            <Typography align="center" sx={{ color: "#FFD700bb", mb: 3, fontSize: { xs: 16, md: 18 } }}>
              Or register manually with your details
            </Typography>
        ...
        >
          <Box sx={{ width: "100%", maxWidth: 760, p: { xs: 0, md: 2 } }}>
            <Typography sx={{ color: '#FFD700', fontWeight: 700, fontSize: { xs: 32, md: 52 }, mb: 2, lineHeight: 1.2 }}>
              MEDICO
            </Typography>
            <Typography
              variant="h2"
              sx={{ fontWeight: 900, fontSize: { xs: 34, md: 58 }, color: "#fff", lineHeight: 1.1, mb: 2 }}
            >
              Your health, on time...
            </Typography>
            <Typography sx={{ color: "#FFD700", fontSize: { xs: 22, md: 34 }, mb: 3, fontWeight: 800, letterSpacing: 0.5 }}>
              Track. Remind. Stay Well!
            </Typography>
            <Typography sx={{ color: '#bbb', fontSize: { xs: 17, md: 23 }, mb: 6, fontWeight: 500 }}>
